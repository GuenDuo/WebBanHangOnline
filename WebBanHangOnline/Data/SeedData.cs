...
namespace WebBanHangOnline.Data
{
    public static class SeedData
    {
        ...
        public static async Task Initialize(IServiceProvider serviceProvider)
        {
            ...
            var adminEmail = "ender492005@gmail.com";
            ...
            if (adminUser == null)
            {
                ...
                {
                    UserName = "guenduo", // Tên đăng nhập là duy nhất
                    Email = adminEmail,
                    FullName = "Nguyễn Lê Dương (Admin)",
                ...
                var result = await userManager.CreateAsync(newAdminUser, "Leduong55");
